...
var LeaveDetailsComponent = (function () {
    function LeaveDetailsComponent(router, navigationManager) {
        var _this = this;
        this.router = router;
        this.navigationManager = navigationManager;
        this.showNavBar = true;
        this.activeMenu = "leavedetails";
...
LeaveDetailsComponent = __decorate([
    core_1.Component({
        selector: 'app',
        templateUrl: 'app/html/leavedetails.component.html'
    }),
    __metadata("design:paramtypes", [router_1.Router, NavigationManager_1.NavigationManager])
], LeaveDetailsComponent);
exports.LeaveDetailsComponent = LeaveDetailsComponent;
//# sourceMappingURL=leavedatails.component.js.map