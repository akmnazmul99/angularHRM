...
var OwnCurrentAttendanceComponent = (function () {
    function OwnCurrentAttendanceComponent(router, navigationManager) {
        var _this = this;
        this.router = router;
        this.navigationManager = navigationManager;
        this.showNavBar = true;
        this.activeMenu = "owncurrentattendance";
    ...
    OwnCurrentAttendanceComponent.prototype.ngOnInit = function () {
    };
    return OwnCurrentAttendanceComponent;
}());
OwnCurrentAttendanceComponent = __decorate([
    core_1.Component({
        selector: 'app',
...
exports.OwnCurrentAttendanceComponent = OwnCurrentAttendanceComponent;
//# sourceMappingURL=owncurrentattendance.component.js.map