...
var TodaysLeaveComponent = (function () {
    function TodaysLeaveComponent(router, navigationManager) {
        var _this = this;
        this.router = router;
        this.navigationManager = navigationManager;
        this.showNavBar = true;
        this.activeMenu = "todaysleave";
    ...
    TodaysLeaveComponent.prototype.ngOnInit = function () {
    };
    return TodaysLeaveComponent;
}());
TodaysLeaveComponent = __decorate([
    core_1.Component({
        selector: 'app',
...
exports.TodaysLeaveComponent = TodaysLeaveComponent;
//# sourceMappingURL=todaysleave.component.js.map